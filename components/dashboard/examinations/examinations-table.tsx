...
export function ExaminationsTable({ examinations }: ExaminationsTableProps) {
  ...
  const columns = [
    ...
    },
    {
      key: "term",
      label: "Term",
      render: (exam: ExaminationWithTerm) => exam.term?.name || "-",
    },
    {
      key: "year",
      label: "Year",
  ...
  return (
    <>
      <DataTable
        columns={columns}
        data={examinations}
        emptyMessage="No examinations found. Add your first examination to get started."
      />
        ...
        <AlertDialogContent className="bg-card border-border">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-muted-foreground">
              Are you sure you want to delete this examination? All results for
              this examination will also be deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
