...
import { ExaminationsTable } from "@/components/teacher-dashboard/examinations-table";
    ...
    return (
        <div className="space-y-6">
            ...
            <Card className="bg-card border-border">
                ...
                <CardContent>
                    <ExaminationsTable examinations={examinations || []} schoolId={profile?.school_id} userId={teacher?.id} />
                </CardContent>
            </Card>
        </div>
    );
